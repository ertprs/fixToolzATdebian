...
elseif ($example == 3){
	...
	echo htmlspecialchars('
		...
		// zoomInc.inc.php contains all needed classes and other files
		// $noObjectsInclude = true; just a switch for not include the zoomObjects.inc.php
		require ("../axZm/zoomInc.inc.php");
		
		// Include (print) all needed stylesheets
		echo $axZmH->drawZoomStyle($zoom); 
		
		// Include (print) all needed js files
	...
	echo htmlspecialchars('
		...
		<a class="ajaxExample" href="/axZm/zoomLoad.php?zoomLoadAjax=1&zoomDir=4&example=4">Example 1</a>
	');
	echo "</pre>";
}
...
elseif ($example == 8){
	...
	echo htmlspecialchars ('
		...
		<script type="text/javascript" src="/axZm/plugins/jquery-1.6.2.js"></script>
		<script type="text/javascript" src="/axZm/jquery.axZm.js"></script>
	');
	echo "</pre>";		
	...
	echo htmlspecialchars ('
		...
		ajaxZoom.opt = {
			...
			onFullScreenStart: function(){
				jQuery("#naviReplacement").css({
					top: jQuery(window).height()-32-10
				});
			},
