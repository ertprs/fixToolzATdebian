...
echo "<DIV style='width: 800px; margin: 0px auto;'>\n";
	...
	echo "<DIV style='float: left; min-height: 600px; min-width: 780px; background-color: #FFFFFF; margin: 5px;'>\n";
		...
		echo "<h2>AJAX-ZOOM - outer image map outside. Mouseover initialization - hover over the image zoom.</h2>\n";
		echo "<DIV style='clear: both;'>\n";
			...
			From Ver. 3.2.0 the image can be opened at "Fullscreen". At the right top of the image area there is a small icon. 
			Clicking on triggers the initialization of fullscreen. Additionally you can trigger fullscreen by clicking on any 
			other icon using the API method $.fn.axZm.initFullScreen(). 
			...
			This can be turned of if thumbnails are already generated by the web shop software: <br />
			<a href="http://www.ajax-zoom.com/index.php?cid=docs#galleryNoThumbs">$zoom[\'config\'][\'galleryNoThumbs\'] = true;</a>
			</span>
			';
