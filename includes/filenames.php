...
// define the filenames used in the project
  ...
  define('FILENAME_PHONE_ME', 'phone_me.php');
  ...
  define('FILENAME_PRODUCT_INFO_S', 'product_infoS.php');
  ...
  define('FILENAME_FAV', 'fav.php');
  define('FILENAME_UPCOMING_PRODUCTS', 'upcoming_products.php');
  define('FILENAME_HOW_I_ORDER', 'how_i_order.php');
  define('FILENAME_ABOUT', 'about.php');
  define('FILENAME_BANNERS', 'banners.php');
  define('FILENAME_TERMS', 'terms.php');
  define('FILENAME_VOUCHER', 'voucher.php');
  define('FILENAME_SCULE', 'scule.php');
  define('FILENAME_CATEGORIES', 'categories.php');
  define('FILENAME_CONVERTOR', 'convertor.php');
  define('FILENAME_FAST_BUY', 'fastbuy.php');
  define('FILENAME_MANUFACTURERS', 'manufacturers.php');
  define('FILENAME_SOCIAL_NETWORKS', 'social_networks.php');
  define('FILENAME_SUBSCRIERE_NEWSLETTER', 'subscriere_newsletter.php');
