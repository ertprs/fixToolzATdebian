...
define('HEADING_TITLE', 'Comanda dumneavoastra a fost trimisa!');
...
define('TEXT_THANKS_FOR_SHOPPING', 'Va multumim pentru ca ati ales Toolszone.ro pentru cumparaturile dumneavoastra!');
