...
define('NAVBAR_TITLE_2', 'Notificari Despre Produse');

define('HEADING_TITLE', 'Notificari Despre Produse');

define('MY_NOTIFICATIONS_TITLE', 'Notificarile Mele');
...
define('GLOBAL_NOTIFICATIONS_TITLE', 'Notificari Globale');
define('GLOBAL_NOTIFICATIONS_DESCRIPTION', 'Recieve notifications on all available products.');

define('NOTIFICATIONS_TITLE', 'Notificari Despre Produse');
