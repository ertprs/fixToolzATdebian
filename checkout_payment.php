            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="right" width="50%" valign="top"><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main" align="center" valign="top"><b><?php echo TITLE_BILLING_ADDRESS; ?></b></td>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td> 
...
?>
              <tr>
                ...
                <td class="main" width="50%" valign="top" align="right"><b></td>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
<?php
  } else {
      ...
      <tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td><?php echo tep_draw_textarea_field('comments', 'soft', '60', '5', $comments, 'class="input"'); ?></td>
              	<td width="10"></td>
              </tr>
            </table></td>
          </tr>
...
?>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td class="main" width="70%"><?php echo TEXT_COUPON; ?></td>
                <td width="30%" align="right"><?php echo tep_draw_input_field('coupon_code'); ?></td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
<?php
  } else {
?>
            	<td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td class="main"><?php echo TEXT_COUPON_ENTERED; ?></td></td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
<?php
  }
?>
