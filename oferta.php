...
<table width="900px">
			...
			<table width="100%">
				<tr>
					...
					<td width="40%" align="right" valign="top">
						...
						Banca: BRD Suc. Brasov<br>
						Cont: RO03BRDE080SV68874720800<br>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td align="left" style="padding-left:30px; padding-bottom:20px; padding-top:20px" class="bold">
			Catre: <input size="70" type="text" style="border:0px; font-weight:bold">
		</td>
	</tr>
	<tr>
		<td align="left" valign="top" >
			<table class="oferta" width="100%" cellspacing="0" class="oferta">
				<tr>
					...
					<th align="center" valign="middle" class="oferta right">9</th>
				</tr>
				<tr>
...
?>
				<tr>
					...
					<td align="center" valign="middle" class="right"><img src="http://www.toolszone.ro/images/mari/<?=$products['products_image'] ?>" border="0" height="130" width="130"></td>
				</tr>
<?
				$i++;
			}
?>				
				<tr>
					<td align="center" valign="middle" colspan="5" style="border:0px">&nbsp;</td>
