...
function startRating(rat){
	
	document.getElementById("rating").value=rat;
	
	for(var i=1; i<=5; i++){
		if(i<=rat)
			document.getElementById("rating_"+i).src="images/icons/star_gold.gif";
		else
			document.getElementById("rating_"+i).src="images/icons/star_silver.gif";
                    ...
                    <td><table border="0" width="100%" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        <td class="main">
                        	...
                        	<?php echo '<b>' . SUB_TITLE_RATING . '</b> '?><img style="cursor:pointer" onMouseOver="startRating(1)" id="rating_1" src="images/icons/star_gold.gif" ><img style="cursor:pointer" id="rating_2" src="images/icons/star_gold.gif" onMouseOver="startRating(2)" ><img style="cursor:pointer" id="rating_3" src="images/icons/star_gold.gif" onMouseOver="startRating(3)" ><img style="cursor:pointer" id="rating_4" src="images/icons/star_gold.gif" onMouseOver="startRating(4)" ><img style="cursor:pointer" id="rating_5" src="images/icons/star_gold.gif" onMouseOver="startRating(5)" >
                        </td>
                      </tr>
                    </table></td>
                  </tr>
