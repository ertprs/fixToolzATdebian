...
menusmap: {},
preloadimages: [],
effects: {delayhide: 50, shadow:{enabled:false, opacity:0.3, depth: [2, 5]}, fade:{enabled:true, duration:100}}, //customize menu effects
...
showmenu:function(menuid){
	...
	if (this.effects.shadow.enabled){
		...
		menu.shadow.setcss({left:posx+anylinkmenu.effects.shadow.depth[0]+'px', top:posy+anylinkmenu.effects.shadow.depth[1]+'px', visibility:'visible', display:'inline'})
	}
	if (this.effects.fade.enabled){
...
hidemenu:function(menuid){
	var menu=anylinkmenu.menusmap[menuid]
	clearInterval(menu.animatetimer)
	menu.dropmenu.setcss({visibility:'hidden', left:0, top:0, display:'none'})
	menu.shadow.setcss({visibility:'hidden', left:0, top:0, display:'none'})
},
