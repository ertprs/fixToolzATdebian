...
<?php
    ...
    ereg('<body>(.*)</div><div class="boxTextLine" style="size:100%"></div><div class="bottom"><div class="bottom_plus_design "><?include("plus_design.php")?></div></div></body>', $phpinfo, $regs);
