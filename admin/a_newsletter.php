...
//$worksheet->setColumn(0,0,0)
    ...
    function xlsWriteHeader($Row, $Col, $Value ) {
        ...
        xlsWriteHeader(0,0,"COMPANIE");
        xlsWriteHeader(0,1,"EMAIL");


        $xlsRow = 1;

        $customers_query_raw = "select * from all_contacts where tip=2 order by id DESC";
        ...
        while ($customers = tep_db_fetch_array($customers_query)) {
            ...
            xlsWriteLabel($rows,0,$customers['companie']);
            xlsWriteLabel($rows,1,$customers['email']);

        }

    $workbook->send("export_newsletter.xls");
    $workbook->close();
}
            ...
            <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                    <tr>
                        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="pageHeading">Clienti inscrisi in newsletter</td>
                                ...
                                <tr>
                                    <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                            <tr class="dataTableHeadingRow">
                                                <td class="dataTableHeadingContent">Companie</td>
                                                <td class="dataTableHeadingContent" align="right">E-mail&nbsp;</td>
                                            ...
                                            while ($customers = tep_db_fetch_array($customers_query)) {
                                                ...
                                                <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='mailto:<?php echo $customers['email']; ?>'">
                                                    <td class="dataTableContent"><?php echo $customers['companie']; ?></td>
                                                    <td class="dataTableContent" align="right"><?php echo $customers['email']; ?>&nbsp;</td>
