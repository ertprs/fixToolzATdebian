...
<!-- body_text //-->
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0" >
      ...
      <tr>
        <td class="boxBgLeft boxBgRight" colspan="3" align="center">        
        <?php
// create column list
  ...
  $from_str = "from " . TABLE_PRODUCTS . " p left join " . TABLE_PRODUCTS_ATTRIBUTES . " m using(products_id) left join " . TABLE_SPECIALS . " s on p.products_id = s.products_id";
  ...
  if (isset($_GET['manufacturers_id']) && tep_not_null($_GET['manufacturers_id'])) {
    $where_str .= " and p.manufacturers_id = '" . (int)$_GET['manufacturers_id'] . "'";
  }
    ...
    for ($i=0, $n=sizeof($search_keywords); $i<$n; $i++ ) {
      switch ($search_keywords[$i]) {
        ...
        default:
          ...
          $where_str .= "(p.nr_articol like '%" . tep_db_input($keyword) . "%' or pd.products_name like '%" . tep_db_input($keyword) . "%' or p.products_model like '%" . tep_db_input($keyword) . "%' or m.cod_unic like '%" . tep_db_input($keyword) . "%'";
