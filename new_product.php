...
*/
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_NEW_PRODUCT);
  ...
  if (isset($_GET['action']) && ($_GET['action'] == 'send')) {
    ...
    if (tep_validate_email($email_address)) {
      ...
      tep_redirect(tep_href_link(FILENAME_NEW_PRODUCT, 'action=success'));
    } else {
      $error = true;
  ...
  $breadcrumb->add(NAVBAR_TITLE, tep_href_link(FILENAME_NEW_PRODUCT));
  
  define('HEADING_TITLE', 'Produs nou');
...
<title><?php echo 'Produs nou'." - ".TITLE; ?></title>
...
<!-- body_text //-->
    <td width="100%" valign="top"><?php echo tep_draw_form('contact_us', tep_href_link(FILENAME_NEW_PRODUCT, 'action=send')); ?>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<td colspan="2" class="infoBoxHeading2" height="32" valign="top" align="left">&nbsp;&nbsp;<?php echo 'Produs nou'; ?></td>
...
?>
      <tr>
    	<td class="boxBgLeft" height="5">&nbsp;</td>
    	<td>&nbsp;&nbsp;&nbsp;</td>
    	<td class="main">Daca nu ati gasit un produs pe site-ul nostru, va rugam sa completati formularul de mai jos, si in cel mai scurt timp o sa procesam cererea dumneavoastra.</td>
        <td class="boxBgRight" height="5">&nbsp;</td>
  	  </tr>
      <tr>
    	<td class="boxBgLeft" height="5">&nbsp;</td>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="main"><?php echo tep_draw_input_field('name', '' ,'class="input" size="40"'); ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo ENTRY_EMAIL; ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo tep_draw_input_field('email', '' ,'class="input" size="40"'); ?></td>
              </tr>
              <tr>
                <td class="main">Produs dorit (Denumire, cantitate, producator, Pret dorit)</td>
              </tr>
              <tr>
                <td><?php echo tep_draw_textarea_field('enquiry', 'soft', 10, 2, '' ,'class="input"'); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
