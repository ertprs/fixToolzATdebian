...
$zoom['config']['licenceType'] = 'Business'; // string

// Version number of this config file
$zoom['config']['version'] = '3.2.2';
...
$zoom['config']['picDim'] = "320x420"; // string
...
// Gallery position
$zoom['config']['galleryPos'] = 'left'; // string (left, right)

// Number of columns vertical gallery
// limited by users resolution and your layout
$zoom['config']['galleryLines'] = 0; // integer
...
$zoom['config']['galFullButton'] = false; // bool
...
$zoom['config']['watermark'] = true; // bool
...
$zoom['config']['wtrmrk']['watermarkTiles'] = true;
...
$zoom['config']['wtrmrk']['composeStyle'] = true;  // bool
...
$zoom['config']['wtrmrk']['fill'] = true; // bool 

// Place watermark on initial picture
$zoom['config']['wtrmrk']['initPic'] = true; // bool 
...
$zoom['config']['txt'][0]['fontText'] = $axZmH->numeric_to_utf8(("Copyright \n\"ToosZone.ro\"\n")); //  
...
$zoom['config']['fullScreenEnable'] = false; // bool

// Enable fullscreen button in the navibar.
$zoom['config']['fullScreenNaviButton'] = false; // bool

// Enable fullscreen button at the top right corner.
$zoom['config']['fullScreenCornerButton'] = false; // bool
...
$zoom['config']['fullScreenMapHeight'] = false;
	...
	$zoom['config']['zoomLoaderPos'] = 'bottom';  
