...
<!-- body_text //-->
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
		...
		<td class="infoBoxHeading2" height="32" valign="top" align="left">&nbsp;&nbsp;<?echo HEADING_TITLE;?></td>
...
?>
              ...
              <tr class="infoBoxContents">
                <td><table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <td class="main"><?php echo tep_draw_input_field('email_address', '', 'class="input" style="width:110px"'); ?></td>
                  </tr>
                  <tr>
                    <td class="main"><?php echo ENTRY_PASSWORD; ?></td>
                    <td class="main"><?php echo tep_draw_password_field('password', '', 'class="input" style="width:110px"'); ?></td>
                  </tr>
                  <tr>
                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                  </tr>
                  <tr>
                    <td class="smallText" colspan="2">Ai uitat parola? <?php echo '<a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">Apasa aici</a>'; ?></td>
                  </tr>
                  <tr>
                    <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                  </tr>
      ...
      <tr>
		...
		<td colspan="1" style="border-bottom: 1px solid #4791d9; font-size:1px;">&nbsp;</td>  
